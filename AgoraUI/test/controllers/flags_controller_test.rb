...
class FlagsControllerTest < ActionController::TestCase
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post :create, flag: { auction_id: @flag.auction_id, flag_type: @flag.flag_type, flagging_user: @flag.flagging_user }
    end
  ...
  test "should update flag" do
    patch :update, id: @flag, flag: { auction_id: @flag.auction_id, flag_type: @flag.flag_type, flagging_user: @flag.flagging_user }
    assert_redirected_to flag_path(assigns(:flag))
  end
